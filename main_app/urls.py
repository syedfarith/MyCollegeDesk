...
urlpatterns = [
    ...
    path("subject/edit/<int:subject_id>",
     ...
     path("Send_circular",hod_views.create_announcement,name="Send_circular"),
     path("view_circular/",hod_views.view_announcement,name="view_circular"),
    ...
    path("view_staff", staff_views.manage_staff, name='sview_staff'),
     path("staff/Send_circular",staff_views.create_announcement,name="create_circular"),
     path("staff/view_acircular/",staff_views.view_announcement,name="view_acircular"),
    ...
    path("student/view/notification/", student_views.student_view_notification,
     ...
     path('timetabel',student_views.timetable,name='timetable'),
     path("staff/view/", student_views.manage_staff, name='view_staff'),
     path("sview_circular/",student_views.view_announcement,name="circular"),
]
